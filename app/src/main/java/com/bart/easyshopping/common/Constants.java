...
public class Constants {
    ...
    public class API{
        ...
        public static final String HOME_BANNER = BASE_API + "banner/query?type=1";  // "首页"轮播广告

        public static final String HOME_CAMPAIGN = BASE_API + "campaign/recommend";  // "首页"数据

        public static final String HOT_WARES = BASE_API + "wares/hot";  // "热卖"数据

        public static final String CATEGORY_LIST = BASE_API +"category/list";    // "分类"一级标题

        public static final String CATEGORY_BANNER = BASE_API +"banner/query?type=1";    // "分类"轮播广告
